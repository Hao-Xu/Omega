...
#include "lib/mathLib/gaussj.h"
#include "lib/mathLib/eigen.h"
...
void Mat_dS_dOmega(r3Tensor<double> &dS_dO, const double & E0_,
    ...
    dsid::dsid(double E0, double Poisson0, double a1,    double a2, double a3, double a4,
    ...
    //--------------------------------------------------------------------------
    void dsid::run(r1Tensor<double> & stnE_, r1Tensor<double> & stnS_ , r1Tensor<double> & stnO_, double & fd0) {
